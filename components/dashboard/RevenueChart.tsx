...
const points = "0,80 40,65 80,50 120,45 160,30 200,40 240,25 280,30 320,20";
    ...
    <div className="rounded-[32px] border border-zinc-200/80 bg-white/95 p-6 shadow-sm shadow-zinc-200/30 backdrop-blur-xl dark:border-zinc-800/80 dark:bg-zinc-950/85 dark:shadow-zinc-950/15">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold text-zinc-950 dark:text-zinc-50">$128.4k</h2>
        </div>
        <span className="rounded-full bg-emerald-100 px-3 py-2 text-sm font-semibold text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300">+14.5% vs last month</span>
      </div>
