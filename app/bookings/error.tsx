...
export default function Error({
  ...
  return (
    <main className="min-h-screen bg-zinc-100 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-100">
      <div className="mx-auto grid max-w-450 gap-6 px-4 py-6 lg:px-8">
        <div className="rounded-4xl border border-rose-200/80 bg-rose-50/95 p-8 shadow-lg shadow-rose-200/40 backdrop-blur-xl dark:border-rose-800/70 dark:bg-rose-950/95 dark:shadow-rose-950/20">
