/** Shared Tailwind class groups for the premium app shell */

export const appShell = "app-shell min-h-[100dvh] text-slate-900 dark:text-zinc-100";

export const appCard =
  "rounded-2xl border border-slate-200/80 bg-white/95 p-5 text-slate-900 shadow-[0_10px_34px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:rounded-3xl sm:p-6 dark:border-cyan-200/10 dark:bg-white/[0.045] dark:text-zinc-100 dark:shadow-[0_8px_32px_rgba(5,8,22,0.38)]";

export const appCardElevated =
  "rounded-2xl border border-slate-200/80 bg-white/95 p-5 text-slate-900 shadow-[0_14px_42px_rgba(15,23,42,0.08)] backdrop-blur-2xl sm:rounded-3xl sm:p-6 dark:border-cyan-200/15 dark:bg-white/[0.06] dark:text-zinc-100 dark:shadow-[0_12px_40px_rgba(2,6,23,0.45)]";

export const appCardInner =
  "rounded-xl border border-slate-200/80 bg-slate-50/80 p-4 text-slate-700 shadow-sm dark:border-white/10 dark:bg-[#050816]/55 dark:text-zinc-200";

export const appEyebrow = "text-xs font-medium uppercase tracking-[0.24em] text-cyan-700 dark:text-cyan-200/75";

export const appTitle = "text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl dark:text-white";
