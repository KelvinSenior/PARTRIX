...
UPDATE "Customer" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "InventoryItem" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "Booking" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "BookingItem" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "Payment" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "Expense" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "Delivery" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "DamageReport" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
UPDATE "ActivityLog" SET "organizationId" = '11111111-1111-1111-1111-111111111111' WHERE "organizationId" IS NULL;
